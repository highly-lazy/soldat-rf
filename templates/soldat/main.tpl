...
<head>
	...
	<link rel="stylesheet" href="{theme}/css/style.css?ver=1.2.7">
	<link rel="stylesheet" href="{theme}/css/sections.css?ver=1.2.7">
	<link rel="stylesheet" href="{theme}/css/engine.css?ver=1.2.7">
</head>
<body>
...
<script src="{theme}/js/main.js?ver=1.2.7" defer></script>
</body>
</html>
