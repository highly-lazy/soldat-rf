...
<head>
	...
	<link rel="stylesheet" href="{theme}/css/sections.css?ver=1.2.3">
	<link rel="stylesheet" href="{theme}/css/engine.css?ver=1.2.3">
</head>
<body>
...
<script src="{theme}/js/main.js?ver=1.2.3" defer></script>
</body>
</html>
