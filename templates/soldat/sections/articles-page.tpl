<section class="list" aria-labelledby="list-title">
	<div class="container">
		...
		<h1 class="list__title" id="list-title">Статьи</h1>

		<div class="list__tabs">
				<button class="list__tab" type="button" aria-current="true">Все статьи</button>
				<button class="list__tab" type="button">Льготы и гарантии</button>
				<button class="list__tab" type="button">Выплаты и довольствие</button>
				<button class="list__tab" type="button">Оформление контракта</button>
				<button class="list__tab" type="button">Семья и документы</button>
		</div>
		...
		<ul class="art__grid list__grid">
				<li class="art__card">
					<a class="art__link" href="{home}/statya.html">
						...
						<span class="art__more">Смотреть подробнее <span class="btn__arrow"><svg class="icon-arrow-ne" viewBox="0 0 12 12" fill="none" aria-hidden="true"><path d="M1.65 10.35 10.35 1.65" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><path d="M3.05 1.65h7.3v7.3" stroke="currentColor" stroke-width="1.3" stroke-linejoin="bevel"/></svg></span></span>
					</a>
				</li>
				<li class="art__card">
					<a class="art__link" href="{home}/statya.html">
